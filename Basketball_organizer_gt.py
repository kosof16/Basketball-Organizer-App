...
if section == "📅 Calendar":
    ...
    with st.expander("📖 Event Types Legend"):
        for event_type, info in EVENT_TYPES.items():
            st.markdown(f"**{info['icon']} {event_type}** - Color: {info['color']}")
...
if not st.session_state.calendar_events:
    ...
    sample_events = [
        ...
        },
        {
            ...
            'description': 'Team bonding and social gathering with food and games',
            'created_at': datetime.now().isoformat(),
            'updated_at': datetime.now().isoformat()
        },
        {
            ...
            'description': 'Team strategy discussion and game planning session',
            'created_at': datetime.now().isoformat(),
            'updated_at': datetime.now().isoformat()
        }
    ]
